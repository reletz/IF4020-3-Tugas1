...
\begin{enumerate}
  ...
  \item Cari faktor dari setiap jarak tersebut dan hitung frekuensi kemunculan setiap faktor (\texttt{VigenereSolver.get\_kasiski\_factors}). Faktor yang paling sering muncul berpeluang besar merupakan panjang kunci atau kelipatannya.
\end{enumerate}
...
\ciphertextfile{../../src/22/log/plain/2026-09-17_132724.txt}
...
Tabel frekuensi \textit{monogram} bahasa Inggris yang digunakan pada Tahap 2 mengacu pada \cite{cornell-freq}. Referensi mengenai konsep dasar dekripsi Vigen\`ere \textit{Cipher} mengacu pada \cite{vigenere-gfg}.
