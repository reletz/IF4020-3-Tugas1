...
Berikut adalah rincian langkah dekripsi untuk tiap blok karakter (Total 134 blok) menjadi vektor numerik, dikali dengan invers matriks kunci modulo 26, lalu dikembalikan ke bentuk teks:

\input{../../src/25/table.tex}
...
\plainfile{../../src/25/log/plain/2026-09-17_201130.txt}
...
\begin{itemize}[nosep]
    \item Slide Kuliah IF4020 Kriptografi: Kriptografi Klasik Bagian 2 (Materi \textit{Hill Cipher} dan \textit{Known-Plaintext Attack}).
    \item GeeksforGeeks, \textit{Hill Cipher}. \url{https://www.geeksforgeeks.org/dsa/hill-cipher/}
\end{itemize}
