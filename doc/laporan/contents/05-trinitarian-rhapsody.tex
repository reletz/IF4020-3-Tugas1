...
\ciphertextfile{../../src/24/log/plain/2026-09-17_131857.txt}

\subsection*{\textit{Plaintext} dengan Format Asli}

\input{../../src/24/plaintext_formatted.tex}
...
Tabel \textit{n-gram} bahasa Inggris bersumber dari \cite{case-ngram} dan \cite{quadgram-data}. Referensi mengenai konsep dasar dan implementasi dekripsi algoritma \textit{Affine Cipher} mengacu pada \cite{affine-gfg}. Konsep \textit{Affine Cipher} dan kriptanalisisnya mengacu pada bahan kuliah \cite{munir-klasik2}, sedangkan perhitungan invers modulo mengacu pada \cite{munir-matematika}.
